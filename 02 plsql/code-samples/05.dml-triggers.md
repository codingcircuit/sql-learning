...
CREATE OR REPLACE TRIGGER app_data_insert_trig
...
CREATE OR REPLACE TRIGGER app_data_update_trig
...
update app_data
SET APP_STATUS = 'on hold'
WHERE APP_ID = 6
;

commit;

CREATE OR REPLACE TRIGGER app_data_delete_trig
    AFTER DELETE ON app_data
    FOR EACH ROW
DECLARE
    v_app_id            app_data.app_id%TYPE;
    v_cust_id           app_data.cust_id%TYPE;
